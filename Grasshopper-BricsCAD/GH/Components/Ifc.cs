...
namespace GH_BC.Components
{
  ...
  {
    public IfcExport() : base("IFC Export", "IFC", "Exports the specified building elements to IFC.", "BricsCAD", UI.GhUI.Output)
    { }
    ...
    {
      pManager.AddParameter(new Parameters.BcEntity(), "BuildingElement", "BE", "Building elements to be exported.", GH_ParamAccess.list);
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
      ...
      var res = Bricscad.Ifc.IfcUtilityFunctions.ExportIfcFile(GhDrawingContext.LinkedDocument, filepath, opt);
